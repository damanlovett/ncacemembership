Last Modification of this file is 18-Oct-2016

UserMgmt is a User Management Plugin for cakephp 3.x
Plugin Premium version 3.2.0 (stable)
with Twitter Bootstrap 3.x

Website- http://ektanjali.com
Plugin Demo and It's features- http://cakephp3-user-management.ektanjali.com/

For Documentations go to http://developers.ektanjali.com/docs/umpremium/version3.2/index.html
...
2. Schema import (use your favorite sql	tool to	import the schema)
	...
	yourapp/plugins/Usermgmt/config/Schema/usermgmt-3.2.sql


3. Configure your AppController	class
	
	you can download the app controller from http://www.ektanjali.com/products/downloadAppController/umpremium3.2
...
You can skip steps 6 to 14 by downloading the zip file from here http://www.ektanjali.com/products/downloadExternalPlugins/umpremium3.2/bootstrap3
...
6. Download twitter bootstrap framework from http://getbootstrap.com/getting-started/#download (at this time latest version is 3.3.7)
...
9. Download bootstrap chosen (chosen_v1.6.2.zip at this time latest version is 1.6.2) file from https://github.com/harvesthq/chosen/releases/
...
11. Download the tinymce editor from http://www.tinymce.com/download/download.php (at this time latest version is TinyMCE 4.4.3)
...
12. Download the ckeditor (full package) editor from http://ckeditor.com/download (at this time latest version is ckeditor 4.5.11)
...
13. Download the jquery from http://jquery.com (at this time latest version is 3.1.1)
Please note I am using jquery-3.1.1.min.js in default layout if you download other jquery version then do not forget to change in default layout.
Directory structure should look like
yourapp/webroot/plugins/jquery-3.1.1.min.js
...
you can download the default layout from http://www.ektanjali.com/products/downloadLayout/umpremium3.2/bootstrap3
