						...
						echo "<td>";
							echo "<div class='btn-group'>";
								...
								echo "<ul class='dropdown-menu'>";
									echo "<li>".$this->Html->link(__('Edit Document'), ['controller'=>'Documents', 'action'=>'edit', $row['id'], 'page'=>$page], ['escape'=>false])."</li>";

									echo "<li>".$this->Form->postLink(__('Delete Document'), ['controller'=>'Documents', 'action'=>'delete', $row['id'], 'page'=>$page], ['escape'=>false, 'confirm'=>__('Are you sure you want to delete this document?')])."</li>";
								echo "</ul>";
							echo "</div>";
						echo "</td>";
					echo "</tr>";
